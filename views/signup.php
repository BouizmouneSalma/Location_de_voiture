    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          <form method="post" action=".././controllers/login.php" class="sign-in-form">
            ...
            <div class="input-field">
              ...
              <input name="pssword" type="password" placeholder="Password" />
            </div>
          ...
          <!----------------- sign up------->
          <form method="post" action=".././controllers/register.php" class="sign-up-form">
